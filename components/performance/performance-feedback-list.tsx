            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold hover:text-primary transition-colors">{report.title}</h3>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Period: {report.period}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <Badge className={typeColors[report.type as keyof typeof typeColors]}>{report.type}</Badge>
                  <Button variant="outline" size="sm" onClick={() => handleReportClick(report.id)}>
