...
export function EvaluationSetup() {
      ...
      const mockCriteria: EvaluationCriteria[] = [
        {
          ...
          description:
            "Demonstrates strong technical skills and delivers high-quality code",
          selected: false,
        },
        {
          id: "2",
          ...
          description:
            "Works effectively with team members and communicates clearly",
          selected: false,
        },
        {
          id: "3",
          ...
          description:
            "Identifies issues proactively and develops effective solutions",
          selected: false,
        },
        {
          id: "4",
        ...
        },
        {
          ...
          title: "Adaptability",
          description:
            "Adjusts well to changing requirements and learns new technologies",
          selected: false,
        },
        {
          id: "6",
          ...
          description:
            "Meets deadlines consistently and manages workload effectively",
          selected: false,
        },
        {
          id: "7",
        ...
        },
        {
          ...
          title: "Mentoring",
          description:
            "Helps junior team members grow and develop their skills",
          selected: false,
        },
      ];
  ...
  const getSelectedCount = () =>
    criteria.filter((item) => item.selected).length;
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              3가지 이상 골라야 평가가 가능합니다. 선택: {getSelectedCount()}/
              {criteria.length}
            </p>
          </CardHeader>
          <CardContent className="space-y-4">
